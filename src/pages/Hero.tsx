      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            >
              <Link to="/contact">
                <Button size="lg" className="glow-border hover:scale-105 transition-transform">
                  Hire Me <ArrowRight className="ml-2" />
                </Button>
              </Link>
              <Link to="/resume">
                <Button variant="outline" size="lg" className="glass-card hover:scale-105 transition-transform">
            ...
            {/* About Section */}
            <motion.div
              className="glass-card p-8 rounded-3xl max-w-3xl mx-auto mb-12"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 1 }}
            >
